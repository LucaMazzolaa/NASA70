...
Il progetto è rivolto a un pubblico generalista interessato allo spazio, alla divulgazione scientifica e alle modalità contemporanee di visualizzazione dei dati. L’interfaccia è pensata per essere accessibile anche a utenti non specializzati, offrendo diversi livelli di lettura che permettono sia un’esplorazione intuitiva sia un approfondimento più analitico dei contenuti.

Il contesto ideale di fruizione è quello di un ambiente digitale quotidiano, come la navigazione da dispositivi personali o in spazi educativi e culturali, tra cui scuole, università e ambienti espositivi dedicati alla scienza e alla ricerca. Il progetto si presta inoltre a essere esplorato in modo libero e individuale, favorendo una fruizione lenta e immersiva dei contenuti.
